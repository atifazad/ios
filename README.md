1. [LocateMe](https://github.com/atifazad/ios/tree/master/LocateMe) is basic app which shows user's current position and its geo coordinates. User can switch map/satellite/hybrid views.
